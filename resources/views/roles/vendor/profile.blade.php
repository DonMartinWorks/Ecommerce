@extends('roles.vendor.dashboard.layouts.master')

@section('content')
    <section id="wsus__dashboard">
        <div class="container-fluid">
            @include('roles.vendor.dashboard.layouts.sidebar')
                        ...
                        <div class="wsus__dashboard_profile">
                            <div class="wsus__dash_pro_area">
                                ...
                                <div class="wsus__dash_pass_change mt-2">
                                    <form action="{{ route('vendor.profile.update.password') }}" method="POST">@csrf
                                        <div class="row">
